...
import com.scriptsbundle.adforest.home.ProgressRequestBody;
...
import com.scriptsbundle.adforest.utills.CircularProgressBar;
...
public class EditAdPost extends AppCompatActivity implements OnMapReadyCallback,
    ...
    Nokri_UploadProgressDialolque progressDialolque;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialolque = new Nokri_UploadProgressDialolque(this);
...
//                        .bearing(180) // Rotate the camera
        ...
        if (resultCode == RESULT_OK && requestCode==321){
            ...
            for (int i =0;i<pathsList.length;i++){
                ...
                JavaCompressor.compress(EditAdPost.this, file1, new com.scriptsbundle.adforest.Callback() {
                    @Override
    ...
    public boolean checkDimensionsAndSizes(File file){
        ...
        return checkDimensions && checkImageSize;
    }
...
//                        .bearing(180) // Rotate the camera
    ...
    public void onError() {
        ...
        progressDialolque.handleFailedScenario();
    }
...
// Remove EditText for youtube link
                if (eachData.getString("field_type").equals("textfield") && !eachData.getString("field_type_name").equals("ad_yvideo")) {
