...
public interface RestService {
    ...
    //Register New user
    @POST("register_check_user/")
    Call<ResponseBody> checkUniquePhone(
            @Body JsonObject register,
            @HeaderMap Map<String, String> headers
    );

    //Register New user
    @POST("login_check_user/")
    Call<ResponseBody> checkUniquePhoneLogin(
            @Body JsonObject register,
            @HeaderMap Map<String, String> headers
    );
    ...
    //Register New user
    @POST("register_otp_user/")
    Call<ResponseBody> registerOTPUser(
            @Body JsonObject register,
            @HeaderMap Map<String, String> headers
    );

    @POST("login_otp_user/")
    Call<ResponseBody> loginOTPUser(
            @Body JsonObject register,
            @HeaderMap Map<String, String> headers
    );
...
//endregion
    ...
    @Multipart
    @POST("post_ad/video/")
    Call<ResponseBody> postUploadVideo(
            @Part("ad_id") RequestBody description,
            @Part("is_required") RequestBody requestBody,
    ...
    @Multipart
    @POST("message/chat_media")
    Call<ResponseBody> postUploadChatFile(
    ...
    @POST("verifyfb_user_number/")
    Call<ResponseBody> sendFBUserNumber(
    ...
    //Message popup view in Ad Details
    @POST("whizchat/whizchat_send_message")
    Call<ResponseBody> postWhizzChatData(
            @Body JsonObject params,
            @HeaderMap Map<String, String> headers
    );
    ...
    //
    @GET("whizchat/whizchatApi_get_chat_list/")
    Call<ChatListModel> getWhizzChatList(
            @HeaderMap Map<String, String> headers
    );

    //
    @POST("whizchat/whizchatApi_get_chat_box")
    Call<ChatModel> getWhizzChat(
            @Body JsonObject params,
            @HeaderMap Map<String, String> headers
    );

    //
    @POST("whizchat/whizchatApi_send_message")
    Call<ResponseBody> sendWhizzChatMessage(
            @Body JsonObject params,
            @HeaderMap Map<String, String> headers
    );
    ...
    @Multipart
    @POST("whizchat/whizchatApi_send_message")
    Call<ResponseBody> whizzChatSendFile(
            ...
            @Part("messages_ids") RequestBody message_id,
