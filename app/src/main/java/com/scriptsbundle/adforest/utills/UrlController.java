...
public class UrlController {
    ...
    public static String IP_ADDRESS = "https://ec.albelal.com/";//Enter You Ip_Address here here
    public static String Purchase_code = "ae844839-ec2d-4a10-b3da-66b20c685f2f";//Enter the purchase code here
    public static String Custom_Security = "p_bo4k.DL=a,sv3kX@Y";//Enter the Custom Security code here
